...
We implemented POMDSoar as a soaring controller integrated into a fork of ArduPlane, the fixed-wing flavor of ArduPilot open-source drone autopilot suite ([original ArduPlane code](https://github.com/ArduPilot/ardupilot/tree/master/ArduPlane), [wiki](http://ardupilot.org/plane/index.html)). The code in the Frigatebird repository allows building this modified version of ArduPlane. Please see [BUILD.md](https://github.com/Microsoft/Frigatebird/blob/master/BUILD.md) for building instructions.

The [DATA](https://github.com/Microsoft/Frigatebird/tree/master/DATA) subdirectory contains ArduPlane parameter files and an example geofenced waypoint course for running POMDSoar on a Radian Pro sUAV as in the experiments in the above paper. 
